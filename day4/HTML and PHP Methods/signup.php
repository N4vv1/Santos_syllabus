        ...
        <form action="insert.php" id="myForm" method="POST">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="nname" placeholder="Nickname" name="nname" required>
                </div>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="tel" class="form-control" id="tel" placeholder="123-4567-8910" name="phone" required>
                </div>
            </div>
            ...
            <p class="text-center">By creating an account, you agree to our 
